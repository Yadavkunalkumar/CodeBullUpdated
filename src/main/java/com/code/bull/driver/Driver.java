...
import com.code.bull.commonutils.action.AssertActions;
import com.code.bull.commonutils.applicationutils.constant.ApplicationConstant;
import com.code.bull.commonutils.applicationutils.constant.ConstantUtils;
...
public class Driver {
    ...
    public static final CommonLip commonLip = new CommonLip();
